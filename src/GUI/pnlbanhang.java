 ...
 */
public class pnlbanhang extends javax.swing.JPanel implements Runnable, ThreadFactory {
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(pnlnennhomkhachhang5, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
                    .addComponent(pnlnennhomkhachhang3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
                    .addComponent(pnlnennhomkhachhang6, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
                    .addComponent(pnlnennhomkhachhang7, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
                    .addComponent(pnlnennhomkhachhang8, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
                    .addComponent(pnlnennhomkhachhang9, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
                    .addComponent(pnlnennhomkhachhang10, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(cbbTatCaSP, 0, 219, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        tbpchuyentab.addTab("Đơn Hàng", pnlDonHang);
    ...
    private void btnMuaHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMuaHangActionPerformed
        ...
        if (ketquasaukhibam == JOptionPane.YES_OPTION) {
            try {
                JasperReport report = JasperCompileManager.compileReport("src/Report/HoaDonBanHang.jrxml");
...
//        tbpchuyentab.addTab("Đơn Mới ", pnldonhang);
//        pnlThemDonHang tdh = new pnlThemDonHang();
//        pnldonhang.add(tdh);
    ...
    public void run() {
        ...
        do {
            ...
            if (result != null) {
                ...
                double tongTien = BLL.BLLHoaDon.DoHoaDonKhiQuetScan(tblChiTietHoaDon, MaSP);
                txtTongTien.setText(BLL.ChuyenDoi.DinhDangTien(tongTien));
                for (int i = 0; i < tblChiTietHoaDon.getRowCount(); i++) {
                    double TongUuDai = BLL.ChuyenDoi.ChuyenTien(txtUuDai.getText());
                    txtUuDai.setText(ChuyenDoi.DinhDangTien(TongUuDai));
