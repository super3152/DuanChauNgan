...
public class pnltrahang extends javax.swing.JPanel {
    ...
    public pnltrahang() {
        ...
        if (SoTraHang == null) {
            ...
            for (int i = 0; i < tblPhieutra.getRowCount(); i++) {
                txtSoLuong.setText(tblPhieutra.getValueAt(i, 2).toString());
            }
    ...
    public pnltrahang(int MaPT, String SoTraHang, String TrangThai, String HoanTien) {
    ...
    private void initComponents() {
        ...
        tblPhieutra.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tên Sản Phẩm", "Số Lượng", "Size", "Màu", "Giá Hàng", "Phí Trả", "Thành Tiền", "Ảnh"
            }
        ) {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(0, 0, 0)
                    .addComponent(pnldanhsach, javax.swing.GroupLayout.DEFAULT_SIZE, 593, Short.MAX_VALUE)
                    .addGap(0, 0, 0)))
        );
    ...
    private void btnTraHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTraHangActionPerformed
         for (int i = 0; i < tblPhieutra.getRowCount(); i++) {
                int SoLuongTra = Integer.parseInt(tblPhieutra.getValueAt(i, 2).toString());
            if (SoLuongTra==0) {
        ...
        for (int i = 0; i < tblPhieutra.getRowCount(); i++) {
            ...
            int SoLuongChon = 0;
            SoLuongChon = Integer.parseInt(tblPhieutra.getValueAt(i, 2).toString());
            double GiaHang = 0;
            GiaHang = BLL.ChuyenDoi.ChuyenTien(tblPhieutra.getValueAt(i, 5).toString());
            double PhiTra = 0;
            PhiTra = BLL.ChuyenDoi.ChuyenTien(tblPhieutra.getValueAt(i, 6).toString());
            double ThanhTien = 0;
            ThanhTien = BLL.ChuyenDoi.ChuyenTien(tblPhieutra.getValueAt(i, 7).toString());
            String GhiChu = "Mới";
            if (SoLuongChon==0) {
                ThongBaoCanhBao.ThongBao("Vui lòng chọn số lượng trả hàng cho tất cả sản phẩm!", "Thông Báo");
            }
    ...
    private void btnNhanHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhanHangActionPerformed
        ...
        for (int i = 0; i < tblPhieutra.getRowCount(); i++) {
            ...
            SoLuongChon = Integer.parseInt(tblPhieutra.getValueAt(i, 2).toString());
            double ThanhTien = ChuyenDoi.ChuyenSangSo(tblPhieutra.getValueAt(i, 5).toString());
    ...
    private void btnDanhSachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDanhSachActionPerformed
        SoTraHang = null;
        GUI.pnlsanpham.jPanel28.remove(this);
        GUI.pnlsanpham.jPanel27.setVisible(true);
    ...
    private void tblPhieutraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPhieutraMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            double ThanhTien = BLL.ChuyenDoi.ChuyenTien(tblPhieutra.getValueAt(dongDuocChon, 7).toString());
            double TongTien = BLL.ChuyenDoi.ChuyenTien(txtTongtien.getText());
            TongTien = TongTien - ThanhTien;
            txtTongtien.setText(BLL.ChuyenDoi.DinhDangTien(TongTien));

            int SoLuongBang = Integer.parseInt(tblPhieutra.getValueAt(dongDuocChon, 2).toString());
