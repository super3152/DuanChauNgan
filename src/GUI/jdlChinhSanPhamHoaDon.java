...
public class jdlChinhSanPhamHoaDon extends javax.swing.JDialog {
    ...
    public jdlChinhSanPhamHoaDon(java.awt.Frame parent, boolean modal) {
        ...
        int dongDuocChon = pnlbanhang.tblChiTietHoaDon.getSelectedRow();
            ...
            txtUuDai.setText(tblChiTietHoaDon.getValueAt(dongDuocChon, 8).toString());
    ...
    private void btnOK1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOK1ActionPerformed
        ...
        double tongTien = BLL.BLLHoaDon.SuaSanPhamVaoChiTietHoaDon(pnlbanhang.tblChiTietHoaDon, sp, slmoi, UuDai, Thue);
        ...
        double UuDaiBanDau = ChuyenDoi.ChuyenSangSo(txtUuDai.getText());
        for (int i = 0; i < tblChiTietHoaDon.getRowCount(); i++) {
            ...
            txtUuDai.setText(ChuyenDoi.DinhDangTien(UuDaiCuoi));
        }
